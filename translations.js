window.uiTranslations = {
  ...
  "19. Conducción en Pared Multicapa (3 Capas en Serie)": "19Multilayer Wall Conduction (3 Layers in Series)",
  "19.89 W/m²": "19.89 W/m²",
  "1·Inicial": "1·Initial",
  "2 Capas": "2 Layers",
  ...
  "2. Ley de Radiación de Max Planck (1900)": "Max Planck's Radiation Law (1900)",
  ...
  // ── Generación Interna (#gen-sim): panel de teoría Ts / ΔT_max / T_max ──
  "Temperatura Superficial ($T_s$):": "Surface Temperature ($T_s$):",
  "Caída Máxima de Temperatura ($\\Delta T_{\\max}$):": "Maximum Temperature Drop ($\\Delta T_{\\max}$):",
  "Temperatura Máxima en el Centro ($T_{\\max}$):": "Maximum Center Temperature ($T_{\\max}$):",
  "Caída Máx. Temp. ($\\Delta T_{\\max}$):": "Max. Temp. Drop ($\\Delta T_{\\max}$):",
  "Temperatura Superficial": "Surface Temperature",
  "Diferencia Máxima de Temperatura": "Maximum Temperature Difference",
  "Incremento Térmico Máximo": "Maximum Thermal Increase",
  "Temperatura Máxima": "Maximum Temperature",
  "La Temperatura Superficial ($T_s$) es la temperatura en la frontera externa del sólido, donde todo el calor generado internamente debe evacuarse por convección hacia el fluido.": "The Surface Temperature ($T_s$) is the temperature at the outer boundary of the solid, where all the internally generated heat must be removed by convection into the fluid.",
  "La Caída Máxima de Temperatura ($\\Delta T_{\\max}$) es el salto térmico entre el centro y la superficie, causado por la resistencia que ofrece el material a conducir el calor generado hasta la frontera.": "The Maximum Temperature Drop ($\\Delta T_{\\max}$) is the thermal jump between the center and the surface, caused by the material's resistance to conducting the generated heat out to the boundary.",
  "La Temperatura Máxima ($T_{\\max}$) ocurre en el centro geométrico del sólido y es igual a la temperatura superficial más la caída máxima de temperatura.": "The Maximum Temperature ($T_{\\max}$) occurs at the geometric center of the solid and equals the surface temperature plus the maximum temperature drop.",

  // ── Generación Interna (#gen-sim): Balance Global de Energía / #gen-energy-balance-box ──
  "Balance Global de Energía": "Global Energy Balance",
  "Balance Global de Energía (Estado Estacionario):": "Global Energy Balance (Steady State):",
  "Tasa Total de Generación": "Total Generation Rate",
  "Tasa Total de Generación de Calor ($\\dot{E}_{\\text{gen}}$):": "Total Rate of Heat Generation ($\\dot{E}_{\\text{gen}}$):",
  "Tasa Total de Generación ($\\dot{E}_{\\text{gen}}$):": "Total Generation Rate ($\\dot{E}_{\\text{gen}}$):",
  "Tasa Volumétrica de Generación": "Volumetric Generation Rate",
  "Tasa Volumétrica de Generación ($\\dot{q}$):": "Volumetric Generation Rate ($\\dot{q}$):",
  "Volumen del Cuerpo": "Body Volume",
  "Volumen del Cuerpo ($V$):": "Body Volume ($V$):",
  "Volumen del Cuerpo (Pared Plana, $V$):": "Body Volume (Flat Wall, $V$):",
  "Calor Disipado por Convección": "Heat Dissipated by Convection",
  "Calor Disipado por Convección ($\\dot{Q}_{\\text{conv}}$):": "Heat Dissipated by Convection ($\\dot{Q}_{\\text{conv}}$):",
  "Volumen y Generación Total según Geometría:": "Volume and Total Generation by Geometry:",
  "Balance Superficial (Generación = Convección):": "Surface Balance (Generation = Convection):",
  "Pared plana (espesor $2L$, área $A$):": "Flat wall (thickness $2L$, area $A$):",
  "Cilindro largo / Varilla (radio $r_0$, longitud $H$):": "Long cylinder / Rod (radius $r_0$, length $H$):",
  "Esfera sólida (radio $r_0$):": "Solid sphere (radius $r_0$):",
  "Pared plana (ambas caras):": "Flat wall (both faces):",

  // ── Generación Interna (#gen-sim): unidades térmicas del balance de energía ──
  "W": "W",
  " W": " W",
  "kW": "kW",
  "W/m³": "W/m³",
  ...
  // ── Generación Interna (#gen-sim): panel #gen-equations-summary-panel ──
  "Ecuaciones de Generación Interna": "Internal Generation Equations",
  "Pared Plana": "Flat Wall",
